  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="mb-2 text-3xl font-bold text-gray-900">API Keys</h1>
        <p className="mb-8 text-gray-600">
          Use these keys to connect the MCP server, CLI, or call the API directly. Keys share your
          account&apos;s credit balance.
        </p>

        {/* Connect hint */}
        <div className="mb-8 rounded-xl border border-gray-200 bg-white p-5">
          <p className="mb-2 text-sm font-medium text-gray-900">MCP server URL</p>
        ...
        <div className="rounded-xl border border-gray-200 bg-white">
          {keys.length === 0 ? (
            <p className="px-5 py-8 text-center text-sm text-gray-500">No API keys yet.</p>
          ) : (
