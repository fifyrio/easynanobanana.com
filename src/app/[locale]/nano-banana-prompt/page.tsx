...
export default function NanoBananaPromptPage() {
  ...
  return (
    <>
      <Head>
        <title>Nano Banana Pro Prompts Gallery - Professional AI Prompt Engineering Examples</title>
        <meta
          name="description"
          content="Explore 9+ professional AI prompts curated by experts. Master prompt engineering with real-world examples covering portrait photography, product shots, logo design, illustration, and style transfer. Learn from the best AI-generated artwork."
        />
        <meta
          name="keywords"
          content="AI prompts, prompt engineering, AI art prompts, professional prompts, AI image generation, portrait prompts, logo design prompts, illustration prompts, nano banana, prompt examples, AI artwork"
        />
        <meta property="og:title" content="Nano Banana Pro Prompts Gallery - Professional AI Prompt Examples" />
        <meta property="og:description" content="Professional AI prompts curated by experts. Master prompt engineering with 9+ real-world examples from portrait photography to logo design." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Nano Banana Pro Prompts Gallery" />
        <meta name="twitter:description" content="Professional AI prompts curated by experts. Master prompt engineering with real-world examples." />
      </Head>
