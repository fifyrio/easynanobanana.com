...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-age-filter/feature/og-image.png`,
          width: 1200,
          height: 630,
          alt: t('ogTitle'),
        },
    ...
    twitter: {
      ...
      title: t('ogTitle'),
      description: t('ogDescription'),
      images: [`https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-age-filter/feature/og-image.png`],
    },
    alternates: {
...
export default async function AiAgeFilterPage({
  ...
  const tFaq = await getTranslations({ locale, namespace: 'aiAgeFilter.faq' });
  ...
  return (
    <>
      ...
      <AiAgeFilterExperience agePresets={presets.age} />
    </>
  );
}
