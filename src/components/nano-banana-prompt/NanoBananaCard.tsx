...
export function NanoBananaCard({ item }: NanoBananaCardProps) {
  ...
  return (
    <>
      ...
      >
        {/* Category Badge */}
        <div className="absolute top-3 left-3 z-10 bg-gray-900/80 text-white backdrop-blur-sm px-3 py-1 rounded-full text-xs font-medium">
          {item.category}
        </div>
        ...
        >
          ...
          >
            ...
            <div className="relative">
              ...
              />
              <div className="absolute top-4 left-4 bg-gray-900/80 text-white backdrop-blur-sm px-3 py-1 rounded-full text-xs font-medium">
                {item.category}
              </div>
            </div>
