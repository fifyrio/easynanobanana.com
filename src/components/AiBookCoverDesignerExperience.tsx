...
export interface BookCoverDesignerPresetAsset {
  displaySrc: string;
  referenceSrc: string;
  fileName: string;
  name: string;
...
interface AiBookCoverDesignerExperienceProps {
  bookCoverPresets: BookCoverDesignerPresetAsset[];
}

const PROMPT_MAP: Record<string, string> = {
  'Fantasy': 'Transform this image into an epic fantasy book cover design. Add dramatic magical elements — glowing runes, mystical creatures, enchanted forests, or castle spires. Use rich deep colors (royal purple, gold, midnight blue). Include ornate decorative borders and elegant serif title typography at the top. Professional book cover layout with author name at the bottom.',
  'Romance': 'Transform this image into a romantic novel book cover design. Apply soft, warm tones — blush pink, sunset gold, lavender. Add dreamy bokeh lights, rose petals, or soft lens flare. Create an intimate, passionate atmosphere with elegant script typography for the title. Professional romance book cover layout.',
  'Sci-Fi': 'Transform this image into a science fiction book cover design. Add futuristic elements — holographic interfaces, starfields, neon circuitry, alien landscapes, or spacecraft. Use a cool color palette (electric blue, cyan, chrome silver). Include bold modern sans-serif title typography. Professional sci-fi book cover layout.',
  'Thriller': 'Transform this image into a dark thriller book cover design. Apply high-contrast dramatic lighting with deep shadows, desaturated tones, and a sense of danger. Add gritty textures, cracked surfaces, or rain effects. Use bold impactful title typography in white or red against dark background. Professional thriller book cover layout.',
  'Mystery': 'Transform this image into a mystery detective book cover design. Create a noir atmosphere with fog, silhouettes, dim streetlights, and long shadows. Use a moody color palette (dark teal, amber, charcoal). Add magnifying glass or keyhole motifs. Elegant serif title typography. Professional mystery book cover layout.',
  'Self-Help': 'Transform this image into a clean modern self-help book cover design. Apply a bright, uplifting aesthetic with clean white space, geometric accents, and one or two bold accent colors. Minimalist composition with large confident sans-serif title typography. Professional non-fiction book cover layout.',
  "Children's": "Transform this image into a colorful children's book cover design. Apply a playful illustrated style with bright primary colors, whimsical characters, rounded shapes, and fun hand-drawn elements. Add stars, clouds, or playful decorations. Use a cheerful rounded font for the title. Professional children's book cover layout.",
  'Horror': 'Transform this image into a terrifying horror book cover design. Apply a dark, unsettling atmosphere with blood-red accents, creepy textures, eerie fog, and disturbing shadows. Add cracked or decaying elements. Use distressed or dripping title typography. Professional horror book cover layout.',
};

const beforeImage = 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/feature/before.png';
const afterImage = 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/feature/after.png';

export default function AiBookCoverDesignerExperience({ bookCoverPresets }: AiBookCoverDesignerExperienceProps) {
  const t = useTranslations('aiBookCoverDesigner');
    ...
    try {
      ...
      if (!response.ok) {
        if (response.status === 401) {
          ...
          setError(data.error || 'Failed to generate book cover design.');
        }
        return;
      }
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        ...
        if (statusData.status === 'completed') {
          if (statusData.resultUrls && statusData.resultUrls.length > 0) {
            ...
            setDescription('Book cover design generated successfully');
      ...
      if (err.name === 'TypeError' && err.message.includes('fetch')) {
        ...
        setError('Failed to generate book cover design. Please try again.');
      }
    } finally {
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-[#FFFBEA] to-white text-slate-900 pb-16">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <label
                      htmlFor="book-cover-designer-upload"
              ...
              <div className="rounded-[36px] border border-[#FFE7A1] bg-white shadow-[0_40px_140px_rgba(196,147,18,0.25)] p-4">
                ...
                >
                  <Image
                    ...
                    alt="AI generated book cover design preview"
                    fill
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      <FreeOriginalDownloadButton
                        ...
                        filename="ai-book-cover-design.png"
        ...
        <section className="bg-gradient-to-b from-[#FFF7DA] via-white to-[#FFF7DA] text-slate-900">
          ...
          <div className="max-w-6xl mx-auto px-4 pb-16 space-y-6">
            {[
              { key: 1, icon: '📚', before: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/cases/case-1-before.png', after: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/cases/case-1-after.png' },
              { key: 2, icon: '🎨', before: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/cases/case-2-before.png', after: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/cases/case-2-after.png' },
              { key: 3, icon: '✨', before: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/cases/case-3-before.png', after: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-book-cover-designer/cases/case-3-after.png' },
            ].map((card, index) => (
              <div
                key={card.key}
      ...
      {generatedImage && (
        <>
          ...
          <ImagePreviewModal
            ...
            imageUrl={generatedImage}
            title="AI Book Cover Design Preview"
          />
        </>
      )}
      <LoginModal
