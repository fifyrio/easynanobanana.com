...
export interface BlackWhiteStylePresetAsset {
  displaySrc: string;
  referenceSrc: string;
  fileName: string;
  name: string;
...
interface AiBlackWhiteConverterExperienceProps {
  blackWhiteStylePresets: BlackWhiteStylePresetAsset[];
}

const beforeImage = 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/feature/before.png';
const afterImage = 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/feature/after.png';

// Per-style transformation guidance used to steer the AI conversion.
const STYLE_PROMPTS: Record<string, string> = {
  'Classic': 'a clean, balanced classic black-and-white look with neutral, even tonal range and natural mid-tones',
  'High Contrast': 'a bold high-contrast monochrome look with deep blacks, bright whites, and punchy dramatic tones',
  'Film Noir': 'a moody film-noir monochrome look with deep shadows, strong directional lighting, and cinematic atmosphere',
  'Soft Grayscale': 'a soft, low-contrast grayscale look with gentle gray tones, smooth gradients, and a delicate matte finish',
  'Vintage Silver': 'a vintage silver-gelatin black-and-white look with fine film grain, subtle tonal warmth, and classic darkroom character',
  'Charcoal': 'a rich charcoal-drawing black-and-white look with deep textured blacks and expressive, artistic shading',
  'Infrared': 'a surreal infrared black-and-white look with glowing bright foliage, dark skies, and dreamlike luminosity',
  'Sepia': 'a warm sepia-toned monochrome look with antique brown tints for a timeless, nostalgic vintage feel',
};

export default function AiBlackWhiteConverterExperience({ blackWhiteStylePresets }: AiBlackWhiteConverterExperienceProps) {
  const t = useTranslations('aiBlackWhiteConverter');
  ...
  const [selectedStyle, setSelectedStyle] = useState<BlackWhiteStylePresetAsset | null>(null);
  ...
  const buildPrompt = () => {
    const styleHint = selectedStyle
      ? STYLE_PROMPTS[selectedStyle.name] || `a ${selectedStyle.name} black-and-white style`
      : 'a clean, balanced classic black-and-white look with a natural tonal range';
    return `Convert this color photograph into a black-and-white image with ${styleHint}. Fully desaturate all colors into monochrome. Preserve every original detail, texture, facial feature, composition, and lighting while producing a professional, high-quality monochrome result.`;
  };
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const finalPrompt = `${promptText} Deliver a photo-realistic black-and-white image powered by Easy Nano Banana. Preserve the original composition, subjects, and details.`;
      ...
      const response = await fetch('/api/generate-image', {
        ...
        body: JSON.stringify({
          prompt: finalPrompt,
          imageUrls,
          metadata: selectedStyle ? { blackWhiteStyle: selectedStyle.name } : undefined,
          aspectRatio,
        }),
      });
      ...
      if (!response.ok) {
        if (response.status === 401) {
          ...
          setError(data.error || 'Failed to generate black-and-white preview.');
        }
        return;
      }
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        ...
        if (statusData.status === 'completed') {
          if (statusData.resultUrls && statusData.resultUrls.length > 0) {
            ...
            setDescription('Black-and-white conversion applied successfully');
      ...
      if (err.name === 'TypeError' && err.message.includes('fetch')) {
        ...
        setError('Failed to generate black-and-white preview. Please try again.');
      }
    } finally {
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-[#FFFBEA] to-white text-slate-900 pb-16">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <label
                      htmlFor="black-white-converter-upload"
                    ...
                    <input
                      type="file"
                      accept="image/*"
                      id="black-white-converter-upload"
                      className="hidden"
                ...
                {/* Black & white style preset selector */}
                <div>
                  ...
                  <div className="grid grid-cols-4 gap-2 sm:hidden">
                    {blackWhiteStylePresets.map((preset) => {
              ...
              <div className="rounded-[36px] border border-[#FFE7A1] bg-white shadow-[0_40px_140px_rgba(196,147,18,0.25)] p-4">
                ...
                >
                  <Image
                    ...
                    alt="AI black and white photo preview"
                    fill
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      <FreeOriginalDownloadButton
                        ...
                        filename="ai-black-white-converter.png"
        ...
        <section className="bg-gradient-to-b from-[#FFF7DA] via-white to-[#FFF7DA] text-slate-900">
          ...
          <div className="max-w-6xl mx-auto px-4 pb-16 space-y-6">
            {[
              { key: 1, icon: '🎞️', before: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/cases/case-1-before.png', after: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/cases/case-1-after.png' },
              { key: 2, icon: '🌗', before: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/cases/case-2-before.png', after: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/cases/case-2-after.png' },
              { key: 3, icon: '⚡', before: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/cases/case-3-before.png', after: 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases/ai-black-white-converter/cases/case-3-after.png' },
            ].map((card, index) => (
              <div
                key={card.key}
      ...
      {generatedImage && (
        <>
          <ShareModal
            ...
            imageUrl={generatedImage}
            description={description || 'AI Black & White Converter by Easy Nano Banana'}
          />
          <ImagePreviewModal
            isOpen={showPreviewModal}
            onClose={() => setShowPreviewModal(false)}
            imageUrl={generatedImage}
            title="AI Black & White Converter Preview"
          />
        </>
      )}
      <LoginModal
