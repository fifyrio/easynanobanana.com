...
export interface PersonalColorStylePresetAsset {
  displaySrc: string;
  referenceSrc: string;
  fileName: string;
  name: string;
...
interface AiPersonalColorExperienceProps {
  personalColorStylePresets: PersonalColorStylePresetAsset[];
}

const R2_BASE = 'https://pub-103b451e48574bbfb1a3ca707ebe5cff.r2.dev/showcases';

const beforeImage = `${R2_BASE}/ai-personal-color/feature/before.png`;
const afterImage = `${R2_BASE}/ai-personal-color/feature/after.png`;

export default function AiPersonalColorExperience({ personalColorStylePresets }: AiPersonalColorExperienceProps) {
  const t = useTranslations('aiPersonalColor');
  ...
  const [selectedPersonalColorStyle, setSelectedPersonalColorStyle] = useState<PersonalColorStylePresetAsset | null>(null);
  ...
  const buildPrompt = () => {
    if (!selectedPersonalColorStyle) {
      return 'Analyze this person\'s skin tone, hair color, and eye color. Create a professional personal color analysis report image.';
    }

    const seasonPrompts: Record<string, string> = {
      'Spring Warm': `Create a professional personal color analysis report for this person. Determine they are a "Spring Warm" type (warm undertone, medium contrast, clear coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Spring Warm" with subtitle "Warm, Bright, Clear". 3) Three metric bars: Warmth 78/100, Contrast 52/100, Clarity 75/100. 4) A "Best Colors" palette section showing coral, peach, warm pink, golden yellow, turquoise, warm green swatches with labels. 5) A "Neutrals" section with ivory, camel, warm beige, light brown swatches. 6) An "Accents" section with salmon, tangerine, apple green, light gold swatches. 7) A brief styling tip at the bottom recommending warm, bright colors and gold jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Spring Light': `Create a professional personal color analysis report for this person. Determine they are a "Spring Light" type (warm undertone, low contrast, light coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Spring Light" with subtitle "Warm, Light, Delicate". 3) Three metric bars: Warmth 68/100, Contrast 28/100, Clarity 62/100. 4) A "Best Colors" palette showing light peach, soft coral, butter yellow, mint green, light aqua, blush pink swatches with labels. 5) A "Neutrals" section with cream, soft taupe, light sand, pale camel swatches. 6) An "Accents" section with apricot, light turquoise, soft lavender, champagne gold swatches. 7) A brief styling tip recommending soft warm pastels and delicate gold jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Summer Cool': `Create a professional personal color analysis report for this person. Determine they are a "Summer Cool" type (cool undertone, medium contrast, muted coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Summer Cool" with subtitle "Cool, Soft, Muted". 3) Three metric bars: Warmth 25/100, Contrast 45/100, Clarity 38/100. 4) A "Best Colors" palette showing dusty rose, soft mauve, powder blue, sage green, lavender, slate blue swatches with labels. 5) A "Neutrals" section with soft white, dove gray, blue-gray, cocoa swatches. 6) An "Accents" section with raspberry, periwinkle, muted teal, rose gold swatches. 7) A brief styling tip recommending cool muted tones and silver or rose gold jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Summer Light': `Create a professional personal color analysis report for this person. Determine they are a "Summer Light" type (cool undertone, low contrast, light coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Summer Light" with subtitle "Cool, Light, Soft". 3) Three metric bars: Warmth 22/100, Contrast 25/100, Clarity 42/100. 4) A "Best Colors" palette showing pastel pink, baby blue, soft lilac, light mint, rose, powder pink swatches with labels. 5) A "Neutrals" section with soft white, light gray, pale blue-gray, misty mauve swatches. 6) An "Accents" section with light plum, sky blue, soft aqua, silver swatches. 7) A brief styling tip recommending light cool pastels and delicate silver jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Autumn Warm': `Create a professional personal color analysis report for this person. Determine they are an "Autumn Warm" type (warm undertone, medium contrast, rich coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Autumn Warm" with subtitle "Warm, Rich, Earthy". 3) Three metric bars: Warmth 82/100, Contrast 55/100, Clarity 48/100. 4) A "Best Colors" palette showing terracotta, olive green, burnt orange, warm red, mustard yellow, teal swatches with labels. 5) A "Neutrals" section with cream, caramel, chocolate brown, khaki swatches. 6) An "Accents" section with copper, rust, forest green, antique gold swatches. 7) A brief styling tip recommending warm earthy tones and gold/copper jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Autumn Deep': `Create a professional personal color analysis report for this person. Determine they are an "Autumn Deep" type (warm undertone, high contrast, deep coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Autumn Deep" with subtitle "Warm, Deep, Intense". 3) Three metric bars: Warmth 75/100, Contrast 78/100, Clarity 55/100. 4) A "Best Colors" palette showing deep olive, burgundy, dark teal, chocolate, burnt sienna, dark tomato red swatches with labels. 5) A "Neutrals" section with dark chocolate, charcoal brown, deep camel, espresso swatches. 6) An "Accents" section with bronze, dark coral, hunter green, antique brass swatches. 7) A brief styling tip recommending deep warm jewel tones and bronze/gold jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Winter Cool': `Create a professional personal color analysis report for this person. Determine they are a "Winter Cool" type (cool undertone, high contrast, clear coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Winter Cool" with subtitle "Cool, Bold, Clear". 3) Three metric bars: Warmth 18/100, Contrast 85/100, Clarity 88/100. 4) A "Best Colors" palette showing true red, royal blue, emerald green, hot pink, pure white, black swatches with labels. 5) A "Neutrals" section with pure white, charcoal, navy, black swatches. 6) An "Accents" section with fuchsia, electric blue, icy violet, platinum silver swatches. 7) A brief styling tip recommending bold high-contrast colors and silver/platinum jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,

      'Winter Deep': `Create a professional personal color analysis report for this person. Determine they are a "Winter Deep" type (cool undertone, very high contrast, deep coloring). The report image should include: 1) The person's photo on the left side. 2) A title "Best Season: Winter Deep" with subtitle "Cool, Deep, Vivid". 3) Three metric bars: Warmth 15/100, Contrast 91/100, Clarity 82/100. 4) A "Best Colors" palette showing deep emerald, cobalt blue, raspberry, plum, true red, deep magenta swatches with labels. 5) A "Neutrals" section with pure white, charcoal, ink navy, blue-gray swatches. 6) An "Accents" section with icy pink, amethyst, blue-red, silver swatches. 7) A brief styling tip recommending deep jewel tones with high contrast and silver jewelry. Clean modern infographic layout with white background, organized sections, professional typography.`,
    };

    return seasonPrompts[selectedPersonalColorStyle.name] || `Create a personal color analysis report for this person in ${selectedPersonalColorStyle.name} style.`;
  };
    ...
    try {
      ...
      const response = await fetch('/api/generate-image', {
        ...
        body: JSON.stringify({
          prompt: finalPrompt,
          imageUrls,
          metadata: selectedPersonalColorStyle ? { personalColorStyle: selectedPersonalColorStyle.name } : undefined,
          aspectRatio,
        }),
      });
      ...
      if (!response.ok) {
        if (response.status === 401) {
          ...
          setError(data.error || 'Failed to generate color analysis.');
        }
        return;
      }
      ...
      for (let attempt = 1; attempt <= maxAttempts; attempt++) {
        ...
        if (statusData.status === 'completed') {
          if (statusData.resultUrls && statusData.resultUrls.length > 0) {
            ...
            setDescription('Personal color analysis report generated successfully');
        ...
        if (statusData.status === 'failed') {
          setError(statusData.error || 'Failed to generate color analysis. Please try again.');
          return;
        }
      }
      ...
      if (error.name === 'TypeError' && error.message?.includes('fetch')) {
        ...
        setError('Failed to generate color analysis. Please try again.');
      }
    } finally {
      ...
      <main className="min-h-screen bg-gradient-to-b from-white via-[#FFFBEA] to-white text-slate-900 pb-16">
          ...
          <div className="grid items-start gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-[32px] border border-[#FFE58F] bg-white/90 shadow-[0_40px_120px_rgba(247,201,72,0.25)] p-6 sm:p-10 space-y-6">
              ...
              <div className="space-y-6">
                ...
                {/* Personal color style preset selector */}
                <div>
                  ...
                  <div className="grid grid-cols-4 gap-2 sm:hidden">
                    {personalColorStylePresets.map((preset) => {
                      const isSelected = selectedPersonalColorStyle?.referenceSrc === preset.referenceSrc;
                      return (
                        <button
                          type="button"
                          key={preset.referenceSrc}
                          onClick={() => setSelectedPersonalColorStyle(isSelected ? null : preset)}
                  ...
                  <div className="mt-3 rounded-2xl border border-[#FFE7A1] bg-[#FFFBF0] p-4 text-xs text-slate-700">
                    ...
                    <p>
                      {selectedPersonalColorStyle
                        ? t('input.preset.summary.selected', { name: selectedPersonalColorStyle.name })
              ...
              <div className="rounded-[36px] border border-[#FFE7A1] bg-white shadow-[0_40px_140px_rgba(196,147,18,0.25)] p-4">
                ...
                >
                  <Image
                    ...
                    alt="AI generated personal color analysis report"
                    fill
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row">
                      <FreeOriginalDownloadButton
                        ...
                        filename="ai-personal-color.png"
        ...
        <section className="bg-gradient-to-b from-[#FFF7DA] via-white to-[#FFF7DA] text-slate-900">
          ...
          <div className="max-w-6xl mx-auto px-4 pb-16 space-y-6">
            {[
              { key: 1, icon: '🎨', before: `${R2_BASE}/ai-personal-color/cases/case-1-before.png`, after: `${R2_BASE}/ai-personal-color/cases/case-1-after.png` },
              { key: 2, icon: '✨', before: `${R2_BASE}/ai-personal-color/cases/case-2-before.png`, after: `${R2_BASE}/ai-personal-color/cases/case-2-after.png` },
              { key: 3, icon: '⚡', before: `${R2_BASE}/ai-personal-color/cases/case-3-before.png`, after: `${R2_BASE}/ai-personal-color/cases/case-3-after.png` },
            ].map((card, index) => (
              <div
                key={card.key}
